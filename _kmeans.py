# COMP 4710 project
# Modified k-means clustering using a modified distance algorithm
# Create a copy of the original _kmeans.py file in .venv\Lib\site-packages\sklearn\clustering
# Replace with this file
# Search COMP4710-EDIT for changes
...
from ..exceptions import ConvergenceWarning # type: ignore
from ..metrics.pairwise import _euclidean_distances, euclidean_distances # type: ignore
from ..utils import check_array, check_random_state # type: ignore
from ..utils._openmp_helpers import _openmp_effective_n_threads # type: ignore
from ..utils._param_validation import Interval, StrOptions, validate_params # type: ignore
from ..utils.extmath import row_norms, stable_cumsum # type: ignore
from ..utils.parallel import ( # type: ignore
    _get_threadpool_controller,
    _threadpool_controller_decorator,
)
from ..utils.sparsefuncs import mean_variance_axis # type: ignore
from ..utils.sparsefuncs_fast import assign_rows_csr # type: ignore
from ..utils.validation import ( # type: ignore
    _check_sample_weight,
    _is_arraylike_not_scalar,
    check_is_fitted,
)
from ._k_means_common import ( # type: ignore
    CHUNK_SIZE,
    _inertia_dense,
    _inertia_sparse,
    _is_same_clustering,
)
from ._k_means_elkan import ( # type: ignore
...
def _kmeans_plusplus(
    ...
    # COMP4710-EDIT CUSTOM DISTANCE - else statement
...
def custom_distances(X1, X2, max_x, squared=True, alpha=1, order=2):
    ...
    Parameters:
        ...
        max_x : float, maximum value of the first feature.
        squared : bool, default=True
            If True, return squared distances to avoid square root calculation.
